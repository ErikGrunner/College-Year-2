alter session set current_schema=coloughlin;/*Setting me current schema to my own group one*/

CREATE TABLE PHARMACY/*This creates our main table the pharmacy table*/
DRUG VARCHAR2 (40),
...
/*This creates the drug info table*/
...
/*This creates our brand info table*/
CREATE TABLE BRAND_INFO (
STOCK_CODE NUMBER (15),
COST_PRICE NUMBER (3),
RETAIL_PRICE NUMBER (3)
);
/*This creates our prescription info table*/
...
/*THis begins our insert expressions, this puts three piece of rows into each of our tables, Everything */
...
INSERT INTO drug_type_info(name_customer, dispence_info, dossage, prescription_only, user_info)
...
/*End of inserts*/
/*Begining of all my select statements*/
...
/*This is the select i think would be most useful to my role, Cashier*/
